...
public class RedBlackBST<Key extends Comparable<Key>, Value> implements MapGeneral {
    ...
    private class Node {
        ...
        private  Association almacen;

        public Node(Key key, Value val, boolean color, int size) {
            this.key = key;
            this.val = val;
            almacen= new Association(this.key,this.val);
            this.color = color;
            this.size = size;
        }
    }
    ...
    private Value get(Node x, Key key) {
        Association a = new Association(key,"");
        Association b = new Association(x.key,"");
        while (x != null) {
    ...
    @Override
    public String buscar(Object key) {
